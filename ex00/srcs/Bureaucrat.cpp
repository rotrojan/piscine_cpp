...
/*   Updated: 2022/01/09 15:58:13 by bigo             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Assigning " << rhs._name << "'s grade to " << this->_name
		<< "." << std::endl;
	if (this != &rhs)
	{
...
{
	return ("The grade level cannot be above 1.");
}

char const	*Bureaucrat::GradeTooLowException::what(void) const throw()
{
	return ("The grade level cannot be under 150.");
}
